    ...
    function createMap(){
        ...
        var point = new BMap.Point(121.109253,31.17422);//定义一个中心点坐标
  ...
  map.addControl(ctrl_sca);
    ...
    //标注点数组
    var markerArr = [{title:"毓荣实业",content:"青浦区清河湾路980号",point:"121.109536|31.174382",isOpen:0,icon:{w:21,h:21,l:0,t:0,x:6,lb:5}}
     ];
    //创建marker
    function addMarker(){
